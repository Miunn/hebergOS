      ...
      <main className="relative py-28 md:py-32">
        ...
        <section className="max-w-[80rem] min-h-screen row-start-2 px-6 mx-auto sm:items-start">
          <section className="relative mx-auto mb-24 md:mb-32 max-w-[80rem] text-center md:px-8">
            ...
            <div className="relative mt-[4rem] md:mt-[8rem] animate-fade-up opacity-0 [--animation-delay:400ms] ">
          ...
          <section className="space-y-32 mx-auto animate-fade-in">
            <section className="flex flex-col-reverse md:grid md:grid-cols-[0.6fr_1fr] gap-20 mx-auto">
              <div>
                <Caribou className="text-[0.5px] font-thin" />
                <h2 className="text-2xl md:text-4xl font-semibold mb-4 md:mb-6">{t('section1.title')}</h2>
            ...
            <section className="flex flex-col-reverse md:grid md:grid-cols-[1fr_0.6fr] gap-20 mx-auto">
              ...
              <div>
                <Caribou className="text-[0.5px] font-thin" />
                <h2 className="text-2xl md:text-4xl font-semibold mb-4 md:mb-6">{t('section2.title')}</h2>
                <p>{t('section2.description')}</p>
              </div>
            </section>

            <section className="flex flex-col md:grid md:grid-cols-[0.6fr_1fr] gap-20 mx-auto">
              <div>
                <Caribou className="text-[0.5px] font-thin" />
                <h2 className="text-2xl md:text-4xl font-semibold mb-4 md:mb-6">{t('section3.title')}</h2>
