...
export default function ContainerTabs({ container }: { container: Container }) {
    ...
    return (
        <Tabs defaultValue="overview">
            <TabsList className="block w-fit h-auto rounded-l-full rounded-r-full mx-auto mb-11">
                <TabsTrigger className="p-2 rounded-l-full" value="overview">{ t('overview') }</TabsTrigger>
                <TabsTrigger className="p-2" value="graphs">{ t('graphs') }</TabsTrigger>
                <TabsTrigger className="p-2" value="shell">{ t('shell') }</TabsTrigger>
                <TabsTrigger className="p-2" value="actions">{ t('actions') }</TabsTrigger>
                <TabsTrigger className="p-2" value="admin">{ t('admin') }</TabsTrigger>
                <TabsTrigger className="p-2 rounded-r-full" value="asks">{ t('asks') }</TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="shell"><ContainerShell /></TabsContent>
